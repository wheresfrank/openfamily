// Package auth implements password hashing, JWT tokens, and TOTP.
package auth
...
// Argon2id parameters. These are reasonable defaults for a self-hosted service.
const (
	argonTime    = 1
...
// encoded string of the form: $argon2id$v=19$m=...,t=...,p=...$<salt>$<hash>.
