...
///
/// Renders a drag handle, the circle header, a scrollable list of member rows,
/// and an "Add a person" row pinned at the bottom. The list is driven by the
/// [scrollController] supplied by the enclosing [DraggableScrollableSheet] so
/// dragging the list also drags the sheet.
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // visible, even when the sheet is collapsed to its minimum size, so
          // members stay glanceable without a separate compact avatar strip.
          Expanded(
